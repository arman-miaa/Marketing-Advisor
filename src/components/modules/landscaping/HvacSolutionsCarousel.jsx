...
const HvacSolutionsCarousel = () => {
  const testimonials = [
    {
      id: 1,
      title: "Get a team of experts that gets landscaping",
      description:
        "You don’t need to build a marketing team—you’ll have one, complete with the experts who understand your seasons, your services, and your goals.",
