...
import img1 from "../../../assets/images/landscaping/Never-miss-an-opportunity-Landscaping.png.2506022308433.webp";
import img3 from "../../../assets/images/hvac/img2.webp";
import img2 from "../../../assets/images/hvac/img3.webp";
      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <Card
            ...
            desc="We capture every call and lead, even when you’re out in the field, with quick responses and easy scheduling, powered by 24/7 AI chat."
            img={img1}
          />
          {/* Card 2 */}
          <Card
            title="Get more of the right clients"
            desc="Target the services and neighborhoods that bring in the highest-paying jobs, from full design-build projects to recurring maintenance contracts."
            img={img2}
          />
          {/* Card 3 */}
          <Card
            title="Make every dollar count"
            desc="We show you exactly what’s working, cut out the waste, double down on what fills your schedule (and weed out what doesn’t)."
            img={img3}
          />
        </div>
