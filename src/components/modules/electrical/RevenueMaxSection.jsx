...
import img1 from "../../../assets/images/electrical/Never-miss-an-opportunity-Electrical.png.2506022308344.webp";
    ...
    <section className="bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 text-white py-12 lg:py-30">
      <div className="container mx-auto px-4 ">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {/* Card 1 */}
          <Card
            title="Fill your schedule, all year round"
            desc="Respond faster, stay booked, and never miss a lead—even when you’re up a ladder or on a service call."
            img={img1}
          />
          {/* Card 2 */}
          <Card
            title="Land the jobs that make you money"
            desc="Target profitable services like panel upgrades, rewiring, EV chargers, and inspections—not tire-kicker calls."
            img={img2}
          />
          {/* Card 3 */}
          <Card
            title="No guesswork. Only growth."
            desc="You know what's working, and we double down on what brings you the best jobs, automatically."
            img={img3}
          />
        </div>
