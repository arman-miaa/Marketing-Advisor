    ...
    <section className="bg-slate-900 py-20 md:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <SharedContentSection
          subtitle="Creative Firepower"
          description="Get a creative team from a company that has more experience building websites for electrical businesses than any other company on Earth."
