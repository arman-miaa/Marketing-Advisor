import rightImg from "../../../../assets/images/electrical/website/Leads-Ai-HS-9.jpg.2505091048325.webp"
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <SharedTitleSection
              category="Loaded with features "
              title="Websites that give you maximum results"
              highlightText="maximum results"
            />
            {/* Bullet Points */}
