  ...
  const cards = [
    {
      ...
      desc: "We rank for the keywords that will drive real revenue, and you’ll know exactly what’s driving results across Google, Bing, and everywhere else people are searching for you.",
    },
    {
      img: img2,
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-3xl text-left -mt-10">
            If your <span className="font-bold">electrical business </span>{" "}
            isn’t ranking when someone searches for you, you’re invisible. Our
