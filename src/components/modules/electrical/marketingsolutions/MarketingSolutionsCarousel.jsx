  ...
  const testimonials = [
    {
      ...
      description:
        "Instantly know how good the lead is, which leads are ready to book, and how your CSRs are turning calls into jobs, with Leads AI.",
      ...
      <div>
        <div className="container mx-auto md:px-10">
          <SharedTitleSection
            ...
            title="Marketing technology for electricians that maximizes your revenue."
            highlightText="revenue."
            description={`More jobs. Better ROI.`}
            descriptionSize="md:text-3xl"
          />
        </div>
