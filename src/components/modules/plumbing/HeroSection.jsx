import HeroVideo from "../../../assets/images/plumbing/output.mp4";
import logo1 from "../../../assets/images/plumbing/Service-TitanLight.png.2505221507161.webp";
import logo2 from "../../../assets/images/plumbing/PHCCLight.png.2505221507156.webp";
import logo3 from "../../../assets/images/plumbing/ThumbtackLight.png.2505231119269.webp";
import logo4 from "../../../assets/images/plumbing/AngiLight.png.2505221507105.webp";
import logo5 from "../../../assets/images/plumbing/Google-PartnerLight.png.2505221507125.webp";
import logo6 from "../../../assets/images/plumbing/Microsoft-Advertising-Stacked-VectorLight.png.2505221507142.webp";
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col justify-center items-center px-6 md:px-56 h-full text-white text-center">
        ...
        <p className="text-2xl lg:text-3xl mb-10 py-4 max-w-2xl leading-relaxed">
          Plumbing marketing that maximizes your revenue.
        </p>
