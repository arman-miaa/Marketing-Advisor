    ...
    <section className="py-30 px-4 bg-blue-50">
      <div className="container mx-auto">
        <div className="text-left mb-8">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-4 leading-20">
            The solutions, commitment, and expertise to deliver{" "}
            <span className="bg-[#d1d5e0] px-2 rounded-2xl">
              maximum growth
            </span>
          </h2>
          <p className="text-xl md:text-3xl font-medium py-6">
            Choose your <span className="font-semibold">industry</span> and
            let’s get started.
          </p>
        </div>

        <div className="relative p-12 py-20 rounded-2xl overflow-hidden shadow-2xl">
          {/* Background Video */}
          <video
            autoPlay
            loop
          ...
          <div className="relative z-10 flex items-center h-full px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full max-w-6xl">
              {/* Left Sidebar */}
              <div
                className="flex flex-col space-y-3 min-w-[380px]"
              ...
              >
                {industries.map((item, index) => (
                  <div
                    ...
                    className={`cursor-pointer flex items-center justify-between px-5 py-10 rounded-xl transition-all duration-300 text-base font-medium backdrop-blur-sm border
                      ${
                        hoveredIndex === index
              ...
              {hoveredIndex !== null &&
                industries[hoveredIndex].subcategories.length > 0 && (
                  <div
                    className="bg-blue-600/40 backdrop-blur-md text-white rounded-xl p-6 border border-blue-400/50 min-w-[300px] shadow-xl"
