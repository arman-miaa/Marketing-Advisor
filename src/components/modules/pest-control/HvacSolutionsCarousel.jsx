import video1 from "../../../assets/images/pest-control/output3.mp4";
    ...
    <section className="bg-gradient-to-b from-gray-900 to-blue-50 py-16 md:pt-30 px-4">
      <div>
        ...
        <div className="text-left mb-12 container mx-auto">
          <SharedTitleSection
            category="Own the block"
            title="Everything you need online to own the neighborhoods you want"
            highlightText="neighborhoods"
            theme="dark"
          />
        </div>
